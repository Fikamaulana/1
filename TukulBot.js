...
//Function RPG & LEVEL By TukulBot Ori
...
//Database RPG Mode By TukulBot!! Ori No
...
//━━━━━━━━━━━━━━━[ MODULE EXPORTS ]━━━━━━━━━━━━━━━\\
	    ...
	    const sender = mek.key.fromMe // Fix Bug by TukulBot
        ? zee.user.jid
        : isGroup
        ? mek.participant
        : mek.key.remoteJid;
        ...
        ? mek.participant
        : mek.key.remoteJid;
	    const OwnerNumber = [`${ownerNumber}@s.whatsapp.net`, `6285279774918@s.whatsapp.net`]
...
🛒 𝗦𝗲𝗹𝗹 𝗜𝗻𝘃𝗲𝗻𝘁𝗼𝗿𝘆
 ...
 • selldiamond`)
        ...
        //+++ || FAKE TROLI         
        const troli =  {key: { fromMe: false,remoteJid: "status@broadcast", participant: '0@s.whatsapp.net'}, message: {orderMessage: {itemCount: 2022, status: 200, thumbnail: tamnel, surface: 200, message: `zeebot`, orderTitle: 'LordTukulBot', sellerJid: '0@s.whatsapp.net'} } }    
...
// Kalo Make Kasi WM Made By TukulBot Ajg!!          
...
//━━━━━━━━━━━━━━━[ GAK USAH DI UBAH ]━━━━━━━━━━━━━━━\\
        ...
        //Beli Di http://wa.me/6285279774918
...
//»»»𝘉𝘶𝘵𝘵𝘰𝘯 𝘉𝘢𝘮𝘩 
    ...
    case 'group': case 'gc': case 'grup':     	 
          ...
          sendButton(from, menu, 'Created By TukulBot', but, troli)
          break           
...
//»»»𝘖𝘸𝘯𝘦𝘳 𝘔𝘦𝘯𝘶
    ...
    case 'bc': case 'broadcast':
          ...
          for (let _ of anu) {
          tes = `${body.slice(4)}`
          zee.sendMessage(_.jid, bc, { contentText: `${tes}`, footerText: `© TukulBot 2K22`, buttons: [{buttonId: `${prefix}menu`,buttonText:{displayText: 'MENU'},type:1},{buttonId: `${prefix}donasi`,buttonText:{displayText:'DONASI'},type:1}],headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: tamnel, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
          }
...
${q+=1}.term`)        
          ...
          sendButton(from, pp, 'Created By TukulBot', but, troli)
          break         
...
vcard3 = 'BEGIN:VCARD\n' +
            ...
            `item2.EMAIL;type=INTERNET:tukulstore175@gmail.com\n` +
            ...
            `item5.X-ABLabel:⚔️ tukul - Botz Owner\n` +
            'END:VCARD'.trim()
zee.sendMessage(from, {displayName: `Creator TukulBot`, vcard: vcard3}, contact, 
{ quoted: troli, 
})
break
   ...
   default:
          ...
          sendButton(from, menu, 'Created By TukulBot', but, mek)
          break
          }
